...
var Autor = /** @class */ (function () {
    function Autor(name, mail, username, id) {
        this.name = name;
        this.id = id;
        this.mail = mail;
...
/* harmony import */ var _form_author_form_author_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./form-author/form-author.component */ "./src/app/form-author/form-author.component.ts");
...
var routes = [
    ...
    {
        path: 'newAuthor',
        component: _form_author_form_author_component__WEBPACK_IMPORTED_MODULE_9__["FormAuthorComponent"]
    },
    {
        path: 'home',
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
            ...
            imports: [
                ...
                ngx_toastr__WEBPACK_IMPORTED_MODULE_20__["ToastrModule"].forRoot() // ToastrModule added
            ],
            providers: [
...
module.exports = "img {\n  height: 10rem;\n  width: 100%; }\n\n.seguir-leyendo {\n  vertical-align: bottom; }\n\narticle {\n  color: darkgray;\n  margin: 5px 0px;\n  display: block; }\n\narticle .loading {\n    width: 10rem; }\n\narticle .title {\n    font-weight: bold;\n    padding: 10px; }\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
module.exports = "<form\r\n  class=\"container-fluid\"\r\n  (ngSubmit)=\"onSubmit(ngForm)\"\r\n  [formGroup]=\"ngForm\"\r\n>\r\n  <div class=\"form-group\">\r\n    <label for=\"titulo\">Nombre </label>\r\n    <input type=\"text\" name=\"nombre\" formControlName=\"nombre\" />\r\n    <span\r\n      class=\"text-danger\"\r\n      *ngIf=\"\r\n        this.ngForm.get('nombre').dirty && this.ngForm.get('nombre').invalid\"\r\n      >Please check nombre</span\r\n    >\r\n  </div>\r\n  <div class=\"form-group\">\r\n    <label for=\"titulo\">Username </label>\r\n    <input type=\"text\" name=\"usuario\" formControlName=\"usuario\" />\r\n    <span\r\n      class=\"text-danger\"\r\n      *ngIf=\"\r\n        this.ngForm.get('usuario').dirty && this.ngForm.get('usuario').invalid\"\r\n      >Please check usuario</span\r\n    >\r\n  </div>\r\n  <div class=\"form-group\">\r\n    <label for=\"titulo\">Email </label>\r\n    <input type=\"text\" name=\"email\" formControlName=\"email\" />\r\n    <span\r\n      class=\"text-danger\"\r\n      *ngIf=\"this.ngForm.get('email').dirty && this.ngForm.get('email').invalid\"\r\n      >Please check email</span\r\n    >\r\n  </div>\r\n  <button\r\n    type=\"submit\"\r\n    [disabled]=\"this.ngForm.invalid\"\r\n    class=\"btn btn-primary\"\r\n  >\r\n    Submit\r\n  </button>\r\n</form>\r\n"
...
/* harmony import */ var _Autor__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../Autor */ "./src/app/Autor.ts");
...
var FormAuthorComponent = /** @class */ (function () {
    function FormAuthorComponent(authorService, postService, toastr) {
        this.authorService = authorService;
        this.postService = postService;
        this.toastr = toastr;
    ...
    Object.defineProperty(FormAuthorComponent.prototype, "nombre", {
        get: function () {
    ...
    Object.defineProperty(FormAuthorComponent.prototype, "usuario", {
        get: function () {
    ...
    Object.defineProperty(FormAuthorComponent.prototype, "email", {
        get: function () {
    ...
    FormAuthorComponent.prototype.initializeForm = function () {
        this.ngForm = new _angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormGroup"]({
    ...
    FormAuthorComponent.prototype.onSubmit = function () {
        var nombre = this.ngForm.get('nombre').value;
        var email = this.ngForm.get('email').value;
        var usuario = this.ngForm.get('usuario').value;
        var author = new _Autor__WEBPACK_IMPORTED_MODULE_6__["Autor"](nombre, email, usuario, this.authorService.getLastId());
        var pusheo = this.authorService.pushAuthor(author);
        if (pusheo) {
            this.showSuccess();
        }
        else {
    ...
    FormAuthorComponent.prototype.showSuccess = function () {
        this.toastr.success('Agregado con exito :)', 'YEAH!', { timeOut: 10000 });
    };
    FormAuthorComponent.prototype.showError = function (error) {
        if (error === void 0) { error = 'void'; }
...
module.exports = "<form class=\"container-fluid\" (ngSubmit)=\"onSubmit(form)\" #form=\"ngForm\">\r\n  <div class=\"form-group\">\r\n    <label for=\"autor\">Autor </label>\r\n    <select id=\"autor\" name=\"autorName\" [(ngModel)]=\"autorID\" required #autor=\"ngModel\">\r\n      <option [value]=\"autor.id\" *ngFor=\"let autor of autores\">\r\n        {{ this.autor.username }}\r\n      </option>\r\n    </select>\r\n    <span\r\n      class=\"text-danger\"\r\n      *ngIf=\"autor.invalid && autor.dirty\"\r\n      >Please check nombre</span\r\n    >  \r\n  </div>\r\n  <div class=\"form-group\">\r\n    <label for=\"titulo\">Titulo </label>\r\n    <input\r\n      type=\"text\"\r\n      required\r\n      minlength=\"3\"\r\n      name=\"tituloName\"\r\n      [(ngModel)]=\"titulo\"\r\n      #titulo=\"ngModel\"\r\n    />\r\n    <span\r\n    class=\"text-danger\"\r\n    *ngIf=\"titulo.invalid && titulo.dirty\"\r\n    >Please check titulo!</span\r\n  >  \r\n  </div>\r\n  <div class=\"form-group\">\r\n    <textarea\r\n      name=\"contenido\"\r\n      cols=\"30\"\r\n      rows=\"10\"\r\n      required\r\n      minlength=\"10\"\r\n      [(ngModel)]=\"contenido\"\r\n      #contenido=\"ngModel\"\r\n    >\r\n    </textarea>\r\n    <span\r\n    class=\"text-danger\"\r\n    *ngIf=\"contenido.invalid && contenido.dirty\"\r\n    >Please check contenido! : {{ contenido.errors }}</span\r\n  >  \r\n  </div>\r\n  <button type=\"submit\" [disabled]=\"form.invalid\" class=\"btn btn-primary\">\r\n    Submit\r\n  </button>\r\n</form>\r\n"
...
module.exports = "main {\n  margin-bottom: 2rem; }\n\n.logo {\n  width: 150px; }\n\n.principal img {\n  height: 10rem;\n  width: 100%; }\n\n.blog-articles article {\n  margin: 5px 0px;\n  display: block; }\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
var AuthorService = /** @class */ (function () {
    function AuthorService(http) {
        ...
        this.listaLocalAutores = [];
        this.lastId = 30;
    }
    AuthorService.prototype.getAutores = function () {
        var _this = this;
        return this.http.get(this.urlUsers).toPromise().then(function (autores) {
            return autores.concat(_this.listaLocalAutores);
        });
    };
    ...
    AuthorService.prototype.getLastId = function () {
        return this.lastId + 1;
    };
    AuthorService.prototype.pushAuthor = function (author) {
        try {
...
var PostService = /** @class */ (function () {
    ...
    PostService.prototype.getPost = function (d) {
        ...
        //   }
        // })
        return this.GetAllPosts().then(function (posts) {
